...
echo "marcas=[{address: '$casa', icon: '../img/icon-casa.png', string: '<div><p>Casa de <b>$nombre</b></p></div>'}, {address: '$otro', icon: '../img/icon-trabajo.png', string: '<div><p>Trabajo de <b>$nombre</b></p></div>'}]";
?>